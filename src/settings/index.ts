...
export class GrazieSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.addToggle(toggle => toggle
				.setValue(this.plugin.settings.useStaging)
				.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addToggle(toggle => toggle
				.setValue(this.plugin.settings.enabledServices.mlec)
				.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addToggle(toggle => toggle
				.setValue(this.plugin.settings.enabledServices.spell)
				.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addToggle(toggle => toggle
				.setValue(this.plugin.settings.enabledServices.rule)
				.onChange(async (value) => {
		...
		new Setting(containerEl)
			...
			.addToggle(toggle => toggle
				.setValue(this.plugin.settings.excludeLinks)
				.onChange(async (value) => {
